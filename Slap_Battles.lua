...
local Window = OrionLib:MakeWindow({IntroText = "Blap Sattles Hub", IntroIcon = "rbxassetid://7733955740",Name = Blap Sattles.. identifyexecutor()), HidePremium = false, SaveConfig = false, IntroEnabled = true, ConfigFolder = "slap battles"})
